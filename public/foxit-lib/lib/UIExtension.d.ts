...
export declare namespace addons {
  ...
  namespace form_designer_addon {
    export import PDFFormPropertiesService = __internal__.PDFFormPropertiesService;

    export import PDFFormProperty = __internal__.PDFFormProperty;

    export import VisibleType = __internal__.VisibleType;
  }
  ...
  export import FormDesignerAddon = __internal__.FormDesignerAddon;
...
export declare namespace controllers {
  ...
  export import AlignAnnotController = __internal__.AlignAnnotController;
  ...
  export import CenterAnnotController = __internal__.CenterAnnotController;
  ...
  export import DistributeAnnotController = __internal__.DistributeAnnotController;
  ...
  export import SizeAnnotController = __internal__.SizeAnnotController;
...
export declare namespace viewerui {
  export import XSignatureUI = __internal__.XSignatureUI;
}
