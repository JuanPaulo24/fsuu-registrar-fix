...
import TabDocumentTranscriptOfRecords from "./components/TabDocumentTranscriptOfRecords/TabDocumentTranscriptOfRecords";
import TabDocumentCertifications from "./components/TabDocumentCertifications/TabDocumentCertifications";
import TabDocumentTrackings from "./components/TabDocumentTrackings/TabDocumentTrackings";
    ...
    const allTabItems = [
        {
            ...
            children: <TabDocumentTranscriptOfRecords />,
            permissionCode: "M-06-TRANSCRIPT"
        },
        {
            key: "Certifications", 
            label: "Certifications",
            children: <TabDocumentCertifications />,
            permissionCode: "M-06-CERTIFICATIONS"
        },
        {
            key: "DocumentTrackings",
            label: "Document Trackings",
            children: <TabDocumentTrackings refreshKey={tabActive} />,
            permissionCode: "M-06-TRACKINGS"
        }
    ];

    // Filter tabs based on permissions from localStorage
    const accessibleTabs = filterAccessibleTabs("Document Management", allTabItems);
                ...
                <Space direction="vertical" size="large" style={{ width: "100%" }}>
                    <div className="module-header">
                        ...
                        <Text type="secondary" className="module-description">
                            Generate, manage, and track academic documents and certifications
                        </Text>
                    </div>
                    
                    <div style={{ textAlign: 'center', padding: '40px 0' }}>
                        <Text type="secondary">
                            You don't have permission to access any document management features.
                        </Text>
                    </div>
                </Space>
            </Card>
