...
import ModalFormVenueBooking from "./ModalFormVenueBooking"; 
...
export default function VenueTable() {
  ...
  const handleSubmit = (newVenue) => {
    const formattedVenue = {
      ...newVenue,
      id: venues.length + 1,
      requester: `${newVenue.requesting_person} (${newVenue.organization})`,
    };
  ...
  return (
    ...
    >
      ...
      <Row justify="start" style={{ marginBottom: 16 }}>
        <Space size="middle">
          <Button
            type={activeView === "active" ? "primary" : "default"}
          ...
          <Button
            type={activeView === "archived" ? "primary" : "default"}
