...
export default function PageUserForm() {
    ...
    const { mutate: mutateUser, isLoading: isLoadingUser } = POST(
        `api/users`,
        "users_registrar_staff_list" // Use same cache key as PageUser
    );
    ...
    const onFinish = (values) => {
        ...
        data.append("course", values.course ? values.course.toUpperCase() : "");
                                                        ...
                                                        <FloatSelect
                                                            ...
                                                            options={
                                                                (
                                                                    ...
                                                                    .filter((item) => item.user_role === 'REGISTRAR STAFF')
                                                                    .map((item) => ({
                                                                        value: item.id,
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <FloatInput
                                                                ...
                                                                placeholder="Last Year Attended (Optional)"
                                                                maxLength={4}
                                                                disabled={formDisabled}
                                                                onKeyPress={(e) => {
                                                                    const char = String.fromCharCode(e.which);
