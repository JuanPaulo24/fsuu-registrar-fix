...
import { faCalendarDays, faGraduationCap } from "@fortawesome/pro-regular-svg-icons";
import CustomTabs from "../../../providers/CustomTabs";
import TabPostingManagement from "./components/TabPostingSettings/TabPostingManagement";
import TabCalendarManagement from "./components/TabCalendarSettings/TabCalendarManagement";
import { filterAccessibleTabs } from "@/hooks/useTabPermissions";

const { Title, Text } = Typography;

export default function PageInformationPanel() {
    ...
    const allTabItems = [
        {
            ...
            children: <TabPostingManagement />,
            permissionCode: "M-07-CMS"
        },
        {
            key: 'calendar',
            label: (
            ...
            children: <TabCalendarManagement />,
            permissionCode: "M-07-EVENTS"
        }
    ];

    // Filter tabs based on permissions from localStorage
    const accessibleTabs = filterAccessibleTabs("Information Panel", allTabItems);
                ...
                <Space direction="vertical" size="large" style={{ width: "100%" }}>
                    <div className="module-header">
                        ...
                        <Text type="secondary" className="module-description">
                            Manage institutional announcements, news updates, and calendar events
                        </Text>
                    </div>
                    
                    <div style={{ textAlign: 'center', padding: '40px 0' }}>
                        <Text type="secondary">
                            You don't have permission to access any information panel features.
                        </Text>
                    </div>
                </Space>
            </Card>
