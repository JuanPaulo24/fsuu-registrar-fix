        ...
        <PageReportContext.Provider value={{ toggleModalForm, setToggleModalForm }}>
            <Card>
                <div className="float-wrapper">
                    ...
                    <Select
                        placeholder="Infant Baptisms"
                        style={{ width: 250, marginRight: 20 }}
                    >
                        <Option value="1">Infant Baptisms</Option>
                        <Option value="2">Adult Baptisms (8 years old above)</Option>
                        <Option value="3">Unbaptized Children of Catholic Parents</Option>
                        <Option value="4">Confirmations</Option>
                        <Option value="5">First Holy Communion</Option>
                        <Option value="6">Sunday Mass Attendance</Option>
                        <Option value="7">Weekday Mass Attendance</Option>
                        <Option value="8">Canonically Celebrated Marriages</Option>
                        <Option value="9">Mixed Marriages</Option>
                        <Option value="10">Marriages with Dispensation from Disparity of Cult</Option>
                        <Option value="11">Marriages with Dispensation from Canonical Form</Option>
                        <Option value="12">Marriages Celebrated in the Extraordinary Form</Option>
                        <Option value="13">Ordination to the Order of Deacons</Option>
                        <Option value="14">Ordination to the Order of Presbyters</Option>
                        <Option value="15">Religious Professions</Option>
                        <Option value="16">Penitents</Option>
                        <Option value="17">Anointing of the Sick</Option>
                        <Option value="18">Funeral Masses</Option>
                        <Option value="19">Conversions</Option>
                    </Select>
